...
public class GSSearch {
	...
	public static String getContent(String url) throws Exception {
		...
		gc.connect();
		getCookies(gc);
		BufferedReader in = new BufferedReader(new InputStreamReader(gc
				.getInputStream()));
		String inputLine;
	...
	public static String retrieveReference(String content) {
		...
		res = "http://scholar.google.de"
				+ res.substring(k + BIBTEX_START.length(), res.length());
		res = res.replaceAll("&amp;", "&");
		return res;
	}
	...
	public static void main(String[] argv) {
		try {
			System.out
					.println(GSSearch
							.getBibTeX("EJOR - Mixed integer programming approach for index tracking and enhansed indexation"));
		} catch (Exception e) {
			Logger.getLogger("bookshepherd").log(Level.SEVERE,
					e.getMessage(), e);			
