...
public class ModelController {
	...
	public List<ExcerptItem> getExcerptItems(List<ReferenceItem> refs,
			final String sort) {
	...
	protected void addItems(ReferenceGroup group, List<ReferenceItem> list,
	...
	public void remove(ReferenceGroup group, ReferenceGroup parent) {
		...
		// remove group from all reference items
		Iterator<ReferenceItemGroup> it = group.getItems().iterator();
